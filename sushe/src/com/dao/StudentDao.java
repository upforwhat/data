...
public class StudentDao {
	...
	public String CheckLogin(String username, String password){
		String id = null;
		String state=null;
		String sql="select * from Student where Student_Username='"+username+"' and Student_Password='"+password+"'" +"   and Student_DomitoryID <> 0 and Student_DomitoryID is not  null and Student_State='入住'" ;
		Statement stat = null;
		ResultSet rs = null;
...
ps.setInt(1, DomitoryID);
		...
		rs.close();
		ps.close();
		System.out.println("现在宿舍有"+count+"人");
