...
public class DomitoryAddSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(list.size()>0)
		{
			out.print("<script language='javascript'>alert('该楼中已经存在该宿舍号！');history.back(-1);</script>");
			out.flush();out.close();return null;
		}
		//添加
		...
		//跳转
		out.print("<script language='javascript'>alert('添加成功！');window.location='admin/domitory/DomitoryManager.jsp';</script>");
		out.flush();out.close();return null;
