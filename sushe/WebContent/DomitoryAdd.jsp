              ...
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="DomitoryAddSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td>
                    <select id="Domitory_Type" name="Domitory_Type" >
<option value="">请选择</option>
                  ...
                  <tr>
                    ...
                    <td><input name="Domitory_Number"  type="text"  class=" easyui-numberbox "   data-options="min:1,max:4" id="Domitory_Number"></td>
                  </tr>
