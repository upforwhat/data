      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="weishengshuidianAdd.action" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="newshijian" type="text" class="easyui-datebox" data-options="required:true" id=shijian ></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>水表度数：</td>
                    <td><input name="newshuidushu" type="text" class="easyui-numberbox" data-options="max:99999,precision:2,required:true" id="Domitory_Number"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>电表度数：</td>
                    <td><input name="newdiandushu" type="text" class="easyui-numberbox" data-options="max:99999,precision:2,required:true"></td>
                  </tr>
                   <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>分数：</td>
                    <td><input name="newscore" type="text" class="easyui-numberbox" data-options="min:0,max:100,precision:1,required:true" ></td>
                  </tr>
                  <tr>
                    <td height="30">&nbsp;</td>
