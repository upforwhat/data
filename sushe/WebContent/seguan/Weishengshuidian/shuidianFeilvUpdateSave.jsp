              ...
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="shuidianFeilvUpdateSave.action" onSubmit="return mycheck()" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr >
                    ...
                    <td ><input name="feilvId" type="text" style="display: none;" id="weiguiid" value="${fl.feilvId}"></td>
                  </tr>
                  
           
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>水单价：</td>
                    <td style="width: 151px; "><input name="shui" type="text" class="text2" id="Domitory_Name" value="<s:property value='fl.shui'/>"></td>
                  ...
                  <tr>
                    ...
                    <td><input name="dian" type="text" class="text2" id="Domitory_Type" value="<s:property value='fl.dian'/>"></td>
