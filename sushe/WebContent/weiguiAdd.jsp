      ...
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="470" align="center" valign="top" bgcolor="#F6F9FE"><form name="form1" method="post" action="weiguiAddSave.action" onSubmit="return mycheck()" >
        ...
        <input class="easyui-combobox" id="BuildingName"
                  ...
                  <tr>
                    ...
                    <td>   <input class="easyui-combobox" id="DomitoryName"
																name="select2"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>时间：</td>
                    <td><input name="shijian" type="text" class="text2" id="Domitory_Type" onClick="WdatePicker()"></td>
                  </tr>
                  <tr>
                    <td height="30" align="right"><span style="color:red;">*</span>原因：</td>
                    <td><input name="yuanyin" type="text" class="text2" id="Domitory_Number"></td>
                  </tr>
                 <%--  <tr>
